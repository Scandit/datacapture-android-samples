...
public final class ColombiaIdBarcodeFieldExtractor extends FieldExtractor {

    private final ColombiaIdBarcodeResult colombiaIdResult;

    public ColombiaIdBarcodeFieldExtractor(CapturedId capturedId) {
        super(capturedId);
    ...
    public List<CaptureResult.Entry> extract() {
        ...
        result.add(new CaptureResult.Entry("Blood Type", extractField(colombiaIdResult.getBloodType())));
