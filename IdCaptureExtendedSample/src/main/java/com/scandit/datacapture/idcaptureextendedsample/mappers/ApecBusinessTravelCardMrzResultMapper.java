...
public final class ApecBusinessTravelCardMrzResultMapper extends ResultMapper {

    private final ApecBusinessTravelCardMrzResult result;

    public ApecBusinessTravelCardMrzResultMapper(CapturedId capturedId) {
        super(capturedId);
        result = capturedId.getApecBusinessTravelCardMrz();
    }

    /*
     * We extract all the ApecBusinessTravelCardMrzResult's specific fields and add them to the
