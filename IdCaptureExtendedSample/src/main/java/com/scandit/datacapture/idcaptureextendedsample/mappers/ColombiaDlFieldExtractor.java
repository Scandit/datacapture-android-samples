...
public final class ColombiaDlFieldExtractor extends FieldExtractor {

    private final ColombiaDlBarcodeResult result;

    public ColombiaDlFieldExtractor(CapturedId capturedId) {
        super(capturedId);
    ...
    public ArrayList<CaptureResult.Entry> extract() {
        ...
        result.add(new CaptureResult.Entry("Categories", extractField(this.result.getCategories())));
        result.add(new CaptureResult.Entry("Identification Type", extractField(this.result.getIdentificationType())));
