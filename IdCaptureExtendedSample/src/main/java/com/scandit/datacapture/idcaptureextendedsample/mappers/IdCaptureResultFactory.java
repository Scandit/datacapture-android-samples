    ...
    private static FieldExtractor getFieldExtractor(
        ...
        switch (capturedResultType) {
            ...
            case COLOMBIA_DL_BARCODE_RESULT:
                return new ColombiaDlFieldExtractor(capturedId);
            case COLOMBIA_ID_BARCODE_RESULT:
                return new ColombiaIdFieldExtractor(capturedId);
            case ARGENTINA_ID_BARCODE_RESULT:
                return new ArgentinaIdFieldExtractor(capturedId);
            case SOUTH_AFRICA_ID_BARCODE_RESULT:
                return new SouthAfricaIdFieldExtractor(capturedId);
            case SOUTH_AFRICA_DL_BARCODE_RESULT:
                return new SouthAfricaDlFieldExtractor(capturedId);
            case US_UNIFORMED_SERVICES_BARCODE_RESULT:
                return new UsUniformedServicesFieldExtractor(capturedId);
            case MRZ_RESULT:
            ...
            default:
                throw new AssertionError(
                        "Unknown captured result type: " + capturedId.getCapturedResultType());
        }
    }
