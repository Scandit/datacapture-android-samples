...
public class ScanAreaLeftMarginFragment extends MeasureUnitFragment {

    public static ScanAreaLeftMarginFragment newInstance() {
        return new ScanAreaLeftMarginFragment();
    }

    private ScanAreaLeftMarginViewModel viewModel;
