...
public class OffsetYFragment extends MeasureUnitFragment {

    public static OffsetYFragment newInstance() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(OffsetYViewModel.class);
    }

    @Override
    public FloatWithUnit provideCurrentFloatWithUnit() {
        return viewModel.getOffsetY();
    }
