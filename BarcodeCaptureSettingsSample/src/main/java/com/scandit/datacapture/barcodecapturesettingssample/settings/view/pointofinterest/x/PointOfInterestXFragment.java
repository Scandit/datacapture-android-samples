...
public class PointOfInterestXFragment extends MeasureUnitFragment {

    public static PointOfInterestXFragment newInstance() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(PointOfInterestXViewModel.class);
    }

    @Override
    public FloatWithUnit provideCurrentFloatWithUnit() {
        return viewModel.getPointOfInterestX();
    }

    @Override
    public void onValueChanged(float newValue) {
        viewModel.setPointOfInterestXValue(newValue);
        refreshMeasureUnitAdapterData();
    }

    @Override
    public void onMeasureUnitChanged(MeasureUnit measureUnit) {
        viewModel.setPointOfInterestXMeasureUnit(measureUnit);
        refreshMeasureUnitAdapterData();
    }
