...
public class LocationRectangularWidthMeasureUnitFragment extends MeasureUnitFragment {

    public static LocationRectangularWidthMeasureUnitFragment newInstance() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(
                LocationRectangularWidthMeasureUnitViewModel.class
        );
    }
