...
public class GesturesSettingsViewModel extends ViewModel {

    private final SettingsManager settingsManager = SettingsManager.getCurrentSettings();

    boolean isTapToFocusEnabled() {
        return settingsManager.isTapToFocusEnabled();
    }

    void setTapToFocusEnabled(boolean enabled) {
        settingsManager.setTapToFocusEnabled(enabled);
    }

    boolean isSwipeToZoomEnabled() {
        return settingsManager.isSwipeToZoomEnabled();
    }

    void setSwipeToZoomEnabled(boolean enabled) {
        settingsManager.setSwipeToZoomEnabled(enabled);
    }
}
