...
public class ScanAreaLeftMarginViewModel extends ViewModel {
    ...
    void setMarginValue(float leftMargin) {
        settingsManager.setScanAreaLeftMargin(
                new FloatWithUnit(leftMargin, getMargin().getUnit())
        );
    }

    void setMarginUnit(MeasureUnit leftMarginUnit) {
        settingsManager.setScanAreaLeftMargin(
                new FloatWithUnit(getMargin().getValue(), leftMarginUnit)
        );
    }
}
