...
public class ViewfinderRectangleWidthViewModel extends ViewfinderTypeViewModel {
    ...
    void valueChanged(float newValue) {
        MeasureUnit currentMeasureUnit = settingsManager.getRectangularViewfinderWidth().getUnit();
        settingsManager.setRectangularViewfinderWidth(
    ...
    void measureChanged(MeasureUnit measureUnit) {
        float currentValue = settingsManager.getRectangularViewfinderWidth().getValue();
        settingsManager.setRectangularViewfinderWidth(
    ...
    FloatWithUnit getCurrentWidth() {
        return settingsManager.getRectangularViewfinderWidth();
    }
}
