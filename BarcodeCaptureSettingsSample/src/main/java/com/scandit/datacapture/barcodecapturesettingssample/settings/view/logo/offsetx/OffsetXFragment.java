...
public class OffsetXFragment extends MeasureUnitFragment {

    public static OffsetXFragment newInstance() {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(OffsetXViewModel.class);
    }

    @Override
    public FloatWithUnit provideCurrentFloatWithUnit() {
        return viewModel.getOffsetX();
    }
    ...
    public void onMeasureUnitChanged(MeasureUnit measureUnit) {
        viewModel.onMeasureChanged(measureUnit);
        refreshMeasureUnitAdapterData();
    }
