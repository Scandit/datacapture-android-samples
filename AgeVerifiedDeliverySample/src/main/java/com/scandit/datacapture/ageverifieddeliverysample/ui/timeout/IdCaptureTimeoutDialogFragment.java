 ...
 * be extracted so far.
 */
public class IdCaptureTimeoutDialogFragment extends BottomSheetDialogFragment {

    /**
     * The tag used by the fragment that informs the user that the given ID or MRZ is
     * detected, but cannot be parsed.
     */
    public static final String TAG = "ID_CAPTURE_TIMEOUT_DIALOG";
     ...
     */
    public static IdCaptureTimeoutDialogFragment create() {
        return new IdCaptureTimeoutDialogFragment();
    }
    ...
    public View onCreateView(
         ...
         */
        View root = inflater.inflate(R.layout.id_capture_timeout_bottom_sheet, container, false);
