...
This sample demonstrates the functionality of the SparkScan API with Jetpack Compose.  It shows how to populate a list of scanned barcodes using the pre-built component for high speed scanning.
