...
public final class StyledCheckboxPreference extends CheckBoxPreference {

    private boolean showDivider;

    public StyledCheckboxPreference(Context context, String key, String title, boolean showDivider) {
        super(context);
        init(key, title, showDivider);
    }

    public StyledCheckboxPreference(Context context, String key, @StringRes int title, boolean showDivider) {
        this(context, key, context.getString(title), showDivider);
    }

    public StyledCheckboxPreference(Context context, String key, @StringRes int title) {
