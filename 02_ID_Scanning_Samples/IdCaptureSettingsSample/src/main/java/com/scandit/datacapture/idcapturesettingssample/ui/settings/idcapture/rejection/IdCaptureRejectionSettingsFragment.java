...
public class IdCaptureRejectionSettingsFragment extends PreferenceFragmentCompat {

    public static IdCaptureRejectionSettingsFragment create() {
        return new IdCaptureRejectionSettingsFragment();
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferenceScreen(
                new SettingsPreferenceBuilder(requireContext())
                        .addSection(new IdCaptureRejectionPreferenceBuilder(requireContext()))
    ...
    private void setupActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.id_capture_rejection_title);
        }
    }
}
