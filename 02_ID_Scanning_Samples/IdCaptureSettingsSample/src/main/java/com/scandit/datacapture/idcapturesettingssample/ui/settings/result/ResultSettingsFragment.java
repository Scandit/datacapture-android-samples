...
public class ResultSettingsFragment extends PreferenceFragmentCompat {

    public static ResultSettingsFragment create() {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferenceScreen(
                new SettingsPreferenceBuilder(requireContext())
                        .addSection(new ResultPreferenceBuilder(requireContext()))
    ...
    private void setupActionBar() {
        ...
        actionBar.setTitle(R.string.result_category_title);
    }
}
