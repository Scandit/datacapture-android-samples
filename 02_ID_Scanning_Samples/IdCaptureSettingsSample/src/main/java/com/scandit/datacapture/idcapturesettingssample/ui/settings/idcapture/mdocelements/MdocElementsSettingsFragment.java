...
public class MdocElementsSettingsFragment extends PreferenceFragmentCompat {

    public static MdocElementsSettingsFragment create() {
        return new MdocElementsSettingsFragment();
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferenceScreen(
                new SettingsPreferenceBuilder(requireContext())
                        .addSection(new MdocElementsPreferenceBuilder(requireContext()))
    ...
    private void setupActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.mdoc_elements_to_retain_title);
        }
    }
}
