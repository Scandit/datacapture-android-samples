...
public class IdCaptureFeedbackSettingsFragment extends PreferenceFragmentCompat {

    public static IdCaptureFeedbackSettingsFragment create() {
        return new IdCaptureFeedbackSettingsFragment();
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferenceScreen(
                new SettingsPreferenceBuilder(requireContext())
                        .addSection(new IdCaptureFeedbackPreferenceBuilder(requireContext()))
    ...
    private void setupActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.id_capture_feedback_title);
        }
    }
}
