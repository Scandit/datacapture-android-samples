...
public class ScanViewModel extends ViewModel implements BarcodeBatchListener,
    ...
    final BarcodeBatch barcodeBatch = dataCaptureManager.barcodeBatch;
    ...
    public ScanViewModel() {
        ...
        dataCaptureManager.barcodeBatch.addListener(this);
    }
    ...
    private void resumeScanningInternal() {
        dataCaptureManager.barcodeBatch.setEnabled(true);
    }

    private void pauseScanningInternal() {
        dataCaptureManager.barcodeBatch.setEnabled(false);
    }
    ...
    public void onSessionUpdated(
            @NonNull BarcodeBatch barcodeBatch,
