...
package com.scandit.datacapture.receivingsample.sparkscan;
...
public class SparkScanPresenter implements
    ...
    public SparkScanPresenter(
        ...
        SparkScanPresenterActions sparkScanPresenterView
    ) {
        ...
        resultsListPresenter =
            new ResultsListPresenter(context, listContainer, ExtraButtonStyle.NONE, true);
