...
import com.scandit.datacapture.barcodecaptureviewssample.models.SettingsManager;
...
public class ScanViewModel extends ViewModel implements BarcodeCaptureListener {
    ...
    public ScanViewModel() {
        ...
        settingsManager.barcodeCapture.addListener(this);
    }
    ...
    public void resumeScanning() {
        settingsManager.barcodeCapture.setEnabled(true);
    }

    public void pauseScanning() {
        settingsManager.barcodeCapture.setEnabled(false);
    }

    public void startFrameSource() {
        if (settingsManager.camera != null) {
            settingsManager.camera.switchToDesiredState(FrameSourceState.ON);
        }
    }

    public void stopFrameSource() {
        if (settingsManager.camera != null) {
            settingsManager.camera.switchToDesiredState(FrameSourceState.OFF);
        }
    }
