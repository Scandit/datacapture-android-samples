...
public class MatrixScanActivity extends CameraPermissionActivity implements BarcodeBatchListener {
    ...
    private void initialize() {
        ...
        // which are then applied to the barcode tracking instance that manages barcode batch.
        ...
        BarcodeBatchBasicOverlay overlay = BarcodeBatchBasicOverlay.newInstance(
            barcodeBatch,
                dataCaptureView,
        ...
        overlay.setListener(new BarcodeBatchBasicOverlayListener() {
            @Override
            @NonNull
