# MatrixScan Count Tote Mapping Sample

This sample demonstrates the pre-built MatrixScan Count component (BarcodeCount API). It shows how to batch scan barcodes using the pre-built component for receiving and counting, with additional tote mapping capabilities.
