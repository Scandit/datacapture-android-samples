...
public class ScanFragment extends CameraPermissionFragment implements ScanViewModel.ScanViewModelListener {
    ...
    public View onCreateView(
        ...
        highlightOverlay = BarcodeBatchBasicOverlay.newInstance(
                viewModel.barcodeBatch, dataCaptureView, BarcodeBatchBasicOverlayStyle.DOT
        );

        // We create an overlay for the bubbles.
        bubblesOverlay = BarcodeBatchAdvancedOverlay.newInstance(
                viewModel.barcodeBatch, dataCaptureView
        );
